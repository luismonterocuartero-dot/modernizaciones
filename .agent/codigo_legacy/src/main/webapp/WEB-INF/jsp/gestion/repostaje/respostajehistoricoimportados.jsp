...
<div class="container mt-2 mb-2">
	<div class="row">
		<div class="col">
			<h1>
				<strong><em>Hist&oacute;rico Repostaje Importados</em></strong>
			</h1>
		</div>
	</div>
	...
	<div class="row">
		<div class="col">
			<!-- Cuadro de aviso -->
			<div id="avisoPermisoHistoricoImp" class="classAviso d-none">Actualmente no dispone de permisos suficientes para acceder a esta pantalla. Por favor, contacte con el Administrador</div>
...
<div class="m-5">
	<div class="col ">
		<!-- Tabla -->
		<table id="tablaRepostajeHistoricoImportados" class="d-none table table-striped table-bordered mb-2">
			<caption></caption>
			<tr><th></th></tr>
		</table>
...
<jsp:include page="modal/modalrepostaje.jsp"/>
	
<script src="resources/js/repostajehistoricoimportados.js" charset="utf-8"></script>
...
<div class="modal fade" data-backdrop="static" id="modalCompania" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
		<h4 id="cabecera" class="modal-title" class="close float-left" id="myModalLabel">Nueva Compa&ntilde;&iacute;a de seguro</h4>
      ...
      <div class="modal-body">
     	<form id="nuevaCompania" action="./crearCompania" method="POST">
     		<input id="idCompania" name="id" type="hidden">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" id="contacto" name="contacto" class="form-control" maxlength="250">
				</div>		
				<!-- Fila 2 -->
				<div class="form-group col-md-4">
					<!-- Telefono -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="guardarCompania" class="btn btn-primary" onclick="crearCompania()">Guardar</button>
      </div>
    </div>
  </div>
</div>
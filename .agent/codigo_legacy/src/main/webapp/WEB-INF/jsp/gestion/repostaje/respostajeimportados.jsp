...
<div class="container mt-2 mb-2">
	<div class="row">
		<div class="col">
			<h1>
				<strong><em>Repostaje Importados</em></strong>
			</h1>
		</div>
	</div>
	...
	<div class="row">
		<div class="col">
			<!-- Cuadro de aviso -->
			<div id="avisoPermisoRepostajeImportado" class="classAviso d-none">Actualmente no dispone de permisos suficientes para acceder a esta pantalla. Por favor, contacte con el Administrador</div>

			<!-- Tabla -->
			<table id="tablaRepostajeImportados" class=" d-none table table-striped table-bordered mb-2">
				<caption></caption>
				<tr><th></th></tr>
			</table>
...
<script src="resources/js/repostajeimportados.js" charset="utf-8"></script>